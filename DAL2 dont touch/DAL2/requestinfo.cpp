...
void RequestInfo::Add(UsersID users_id) {
...
void RequestInfo::Delete(UsersID users_id) {
  ExectuteQuery(DeleteQuery(users_id));
  query_.finish();
}

QString RequestInfo::AddQuery(UsersID users_id) {
  return QString(
...
QString RequestInfo::DeleteQuery(UsersID users_id) {
